...
import DownloadOptions from './DownloadOptions'; // [수정] 새로 만든 컴포넌트 import

// --- Types & Constants ---
type ArtDimensions = { w: number; h: number };
type AsciiCell = { char: string; color: string };
// [수정] DownloadOptions.tsx에서 import할 수 있도록 'export' 키워드 유지
...
// const PNG_SCALE_OPTIONS = [1, 2, 4]; // [제거] DownloadOptions.tsx로 이동
...
// [제거] DownloadOptions 컴포넌트 정의 (별도 파일로 이동)
/*
