...
export function ProjectIntroModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4 text-white"
      onClick={onClose}
    >
      <div
        className={`w-full max-w-5xl cursor-pointer ${projects.includes("piano") ? "md:translate-x-[90px]" : ""}`}
        onClick={(e) => {
          e.stopPropagation();
          onClose();
        }}
