...
const UploadIcon = () => (
  <svg className="w-8 h-8 md:w-10 md:h-10 mb-2 md:mb-3 text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
...
const CameraIcon = () => (
  <svg className="w-8 h-8 md:w-10 md:h-10 text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      ...
      >
        ...
        {isCameraOpen ? (
          ...
          <div className="flex flex-col items-center text-center">
            <UploadIcon />
            <p className="-mt-2 md:-mt-3 text-base md:text-lg font-semibold text-gray-800">{title1}</p>
            <p className="mt-1 md:mt-2 mb-1 md:mb-2 text-xs md:text-sm text-gray-400">{subtitle}</p>
            <p className="-mb-2 md:-mb-3 text-base md:text-lg font-semibold text-gray-800">{title2}</p>
            <button
              type="button"
              onClick={(e) => {
                e.stopPropagation();
              ...
              className="p-1 md:p-2 mt-1 md:mt-2 rounded-full hover:bg-gray-200 cursor-pointer"
            >
              <CameraIcon />
            </button>
          </div>
