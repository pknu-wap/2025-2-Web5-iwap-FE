...
export default function FunctionsPage() {
  ...
  return (
    <div className="relative w-full h-[calc(100dvh-96px)]">
      <FullScreenView
        title="Th!s !s for u"
        subtitle="함수로 하트 그리기"
        goBack={true}
      ...
      >
        {/* [수정] 불필요한 그래디언트 오버레이 div 제거 */}
        <div
          ref={ref}
          className="w-[90vw] max-w-[1501px] h-[65vh] max-h-[700px] bg-white
