...
export async function GET(req: NextRequest) {
  try {
    ...
    console.log(`[API/piano/mp3] GET request: ${targetUrl}`);
    ...
    if (!res.ok) {
        console.error(`[API/piano/mp3] Backend response status: ${res.status}`);
    }
    ...
    console.error(`[API/piano/mp3] Error: ${message}`);
