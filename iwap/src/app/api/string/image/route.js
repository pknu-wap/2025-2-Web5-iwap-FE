...
export async function GET(request) {
  let logMessage = `CLIENT REQUEST: GET /api/string/image/`;
  ...
  try {
    ...
    // 2. 백엔드에 요청
    const response = await fetch(`${BACKEND_URL}/api/string/image`, {
      method: 'GET',
    ...
    logMessage += `\n  -> SUCCESS: Fetched image blob. (Type: ${contentType})`;
    ...
    console.error(`[/api/string/image] API Proxy Error:`, error);
